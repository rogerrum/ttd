...
RUN apt-get update -y && \
    ...
    apt-get install -y --no-install-recommends dumb-init wget unzip ca-certificates libfontconfig1 libfreetype6 libfluidsynth2 libicu-dev libpng16-16 liblzma-dev liblzo2-2 libsdl1.2debian libsdl2-2.0-0  && \
